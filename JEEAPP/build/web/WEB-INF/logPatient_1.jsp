...
<html>
    ...
    <body onload="initialize()" >
        ...
        <div class="content">
            ...
            <!-- End: slider -->
            <!-- Start: Nearby Map -->
<!--            <form class="form-add-user" action="distanceServe" method="Post">
                            ...
                            <div class="span5 offset1">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="text" name="distance" id="address" placeholder="Threshold Km">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" name="userID" id="mcID" value="<%= uid %>">

                                        <input type="submit" class="btn btn-primary btn-large" value="Find">
                                    </div>
                                </div>
                            </div>   
            </form>-->
            <div class = "container">
                <div class="row-fluid">
                    ...
                    <h3 align="center">Please select medical center location from map to get the appointment details.... </h3>
